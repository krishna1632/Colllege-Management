    ...
    <div class="row">
        ...
        <div class="container col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    <!-- Profile Picture -->
                    <img src="{{ $user->profile_picture_url }}" alt="Profile Picture" class="rounded-circle" width="150"
                        height="150">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9"><input type="file" class="form-control" id="profilePic"></div>
